...
parameters = struct(...
    ...
    'threshStdMult',[20],... % multiples of standard deviation above the baseline as the parameters.threshold for TKEO detection. All channels will use the same value if there is only one value, multiple values are allowed for different channels
    ...
    'showFilt',0,...
    'showOverlap',1,...
    'showOverlapFull',0,...  % show everything about the overlapping analysis
    'showFFT',0,...
    'showCompare',0,...
