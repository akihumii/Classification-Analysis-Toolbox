...
sign = 11; % input 1 for threhoslding upwards, input -1 for thresholding downwards
windowSize = [0.03, 0.7]; % range of window starting from the detected peaks(in seconds)
