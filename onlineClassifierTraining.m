...
switch targetSubject
    ...
    case 'NHP'
        [signal,signalClassificationInfo,saveFileName] = mainClassifier('threshStdMult',threshMult,'baselineType','movingWindow',...
            'saveOverlap',1,'showOverlap',1,'showRaw',0,'showFilt',0,'saveRaw',0,'saveFilt',0,...
            'threshStdMult',[25,10,10,15],'TKEOStartConsecutivePoints',[25,45,45,45],'saveUserInput',1,'padZeroFlag',0,'burstTrimming',0); % to detect the bursts
