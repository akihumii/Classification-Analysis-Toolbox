function output = dataClassificationPreparation(signal, iter, selectedWindow, windowSize, threshold)
...
output(i,1) = detectSpikes(output(i,1), signal(i,1), 'dataRaw', 'threshold', threshold);
