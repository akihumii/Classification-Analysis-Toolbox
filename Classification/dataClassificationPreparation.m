function output = dataClassificationPreparation(signal, iter, selectedWindow, windowSize, dataToBeDetectedSpike, spikeDetectionType, threshold, sign, TKEOStdMult, TKEOStartConsecutivePoints, TKEOEndConsecutivePoints)
%dataClassification Detect windows, extract features, execute
%classification
%   output = dataClassificationPreparation(signal, iter, selectedWindow, windowSize, dataToBeDetectedSpike, spikeDetectionType, threshold, sign, TKEOStdMult, TKEOStartConsecutivePoints, TKEOEndConsecutivePoints)
...
output(i,1) = detectSpikes(output(i,1), signal(i,1), dataToBeDetectedSpike, spikeDetectionType, threshold, sign, TKEOStdMult, TKEOStartConsecutivePoints, TKEOEndConsecutivePoints);
