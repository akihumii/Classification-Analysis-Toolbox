...
plotFeatures('accuracy','medianPlot',numChannel,fileSpeed,fileDate,outputIndividual,xCoordinates,iters,leftCoordinates,fileSpeedOnly,dataTemp,'channel');

plotFeatures('maxValue','meanPlot',numChannel,fileSpeed,fileDate,outputIndividual,xCoordinates,iters,leftCoordinates,fileSpeedOnly,dataTemp,'channel');

plotFeatures('BL','meanPlot',numChannel,fileSpeed,fileDate,outputIndividual,xCoordinates,iters,leftCoordinates,fileSpeedOnly,dataTemp,'channel');

plotFeatures('meanValue','meanPlot',numChannel,fileSpeed,fileDate,outputIndividual,xCoordinates,iters,leftCoordinates,fileSpeedOnly,dataTemp,'channel');
...
for i = 1:maxNumFeatureUsed
    ...
    pS{i,1} = plotFeatures('sensitivity','medianPlot',numChannel,fileSpeed,fileDate,outputIndividualTemp,xCoordinates,iters,leftCoordinates,fileSpeedOnly,dataTemp,[num2str(i),'-feature classification channel']);
