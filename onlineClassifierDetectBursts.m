...
switch targetSubject
    ...
    case 'NHP'
        [signal,signalClassificationInfo,saveFileName,~,parameters] = ...
            ...
            'threshold',0,'threshStdMult',threshMult,'showOverlap',0,'baselineType','movingWindow',...
            'markBurstInAllChannels',handles.UserData.multiChannelFlag,...
            ...
            'datathresholdOmitFlag',0,'dataToBeDetectedSpike','dataTKEO','spikeDetectionType','TKEO','partialDataSelection',0,...
            'TKEOStartConsecutivePoints',[25,45,45,60],'TKEOEndConsecutivePoints',[30],'saveUserInput',1,'padZeroFlag',0,'burstTrimming',0); % to detect the bursts
        %             'makeFirstFileBaseline',handles.UserData.multiChannelFlag,'burstLen',str2num(handles.inputWindowSize.String)/1000,...
