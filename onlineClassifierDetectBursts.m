...
switch targetSubject
    ...
    case 'NHP'
        [signal,signalClassificationInfo,saveFileName,~,parameters] = ...
            ...
            'partialDataSelection',0,'TKEOStartConsecutivePoints',[25,45,45,45],'TKEOEndConsecutivePoints',[60],'saveUserInput',1,'padZeroFlag',0,'burstTrimming',0); % to detect the bursts
