...
switch targetSubject
    ...
    case 'NHP'
        [signal,signalClassificationInfo,saveFileName,~,parameters] = ...
            mainClassifier('dataType','sylphx','channel',4:7,'channelAveragingFlag',0,'selectFile',1,...
            'highPassCutoffFreq',100,'lowPassCutoffFreq',500,'getBaselineFeatureFlag',~handles.UserData.multiChannelFlag,...
            'dataThresholdOmitFlag',0,'restoreSyncPulseFlag',0,'dataPeriodicOmitFrequency',0,...
            'threshold',0,'markBurstInAllChannels',handles.UserData.multiChannelFlag,...
            'burstLen',str2num(handles.inputWindowSize.String)/1000,'threshStdMult',threshMult,'showOverlap',0,'baselineType','movingWindow',...
            'saveOverlap',0,'showRaw',0,'showFilt',0,'showRaster',0,'saveRaster',0,'saveRaw',0,'saveFilt',0,'saveOverlap',0,'showCompare',0,'saveCompare',0,...
            'datathresholdOmitFlag',0,'dataToBeDetectedSpike','dataTKEO','spikeDetectionType','TKEO','partialDataSelection',0,'TKEOStartConsecutivePoints',[25,45,45,45],'TKEOEndConsecutivePoints',[100],'saveUserInput',1,'padZeroFlag',0,'burstTrimming',0); % to detect the bursts
