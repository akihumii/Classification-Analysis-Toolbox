...
switch targetSubject
    ...
    case 'NHP'
        [signal,signalClassificationInfo,saveFileName,~,parameters] = ...
            ...
            'optimizeTKEOFlag',1,'featuresID',handles.UserData.featuresID,...
            'spikeDetectionType','TKEOmore','stepWindowSize',0.05,...
            'partialDataSelection',0,'TKEOStartConsecutivePoints',[25,45,45,45],'TKEOEndConsecutivePoints',[100],'saveUserInput',1,'padZeroFlag',0,'burstTrimming',0); % to detect the bursts
